...
<head>
    ...
    <title>Zesco Bills For <?php echo $getAccountNumber; ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Zesco Transactions For Account <?php echo $getAccountNumber; ?></strong>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                        $result = mysqli_query($con,"SELECT * FROM utility_transactions WHERE utility_acc_no ='ZESCO' AND client_acc_no = '$getAccountNumber'");
