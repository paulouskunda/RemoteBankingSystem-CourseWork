                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Client's Accounts</strong>
                            </div>
                                ...
                                <table  id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="table_details.php?acc=<?php echo $row["account_number"]; ?>"><button class="btn btn-primary">View Trans</button></a></td>
                                            <td><a href="view_zesco.php?acc=<?php echo $row["account_number"]; ?>"><button class="btn btn-dark">View  Zesco Trans</button></td>
