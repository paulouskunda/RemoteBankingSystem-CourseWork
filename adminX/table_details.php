...
$accountSQL = "SELECT * FROM account WHERE account_number  = '$getAccountNumber'";
...
<head>
    ...
    <title>Transactions Table for <?php echo $getAccountNumber; ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Transactions For Account <?php echo $getAccountNumber; ?></strong>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                        $result = mysqli_query($con,"SELECT * FROM transactions WHERE sender_acc_no = '$getAccountNumber' OR receiver_acc_no = '$getAccountNumber'");
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                if ($getAccountNumber == $row['receiver_acc_no']) {
                                                    # code...
                                                    echo "<td>Received funds from ".$row['receiver_acc_no']."</td>";
                                                } else  {
                                                    echo " <td>".$row["remark"]."</td>";
                                                }
                                            ?>
                                           
                                            <?php  echo '<td>'.number_format($row["transaction_amount"]).'</td>';
                                                    $totalTrans_Made += $row["transaction_amount"];
                                             ?>
                                            
                                        
                                        </tr>
                                         <?php }
                                                echo "<div class='alert alert-info' style='text-align:right;'>Total Transfers made: ZMK ".number_format($totalTrans_Made)."</div>";
                                          ?>
                                    </tbody>
