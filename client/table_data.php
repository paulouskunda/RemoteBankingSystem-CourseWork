...
<head>
    ...
    <title>Client DashBoard For Account <?php echo $_SESSION['account_number']; ?></title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Transactions Made <?php echo $account_number; ?></strong>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                        $result = mysqli_query($con,"SELECT * FROM transactions WHERE sender_acc_no = '$account_number' OR receiver_acc_no = '$account_number' AND receiver_acc_no != 'ZESCO'");
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                if ($account_number == $row['receiver_acc_no']) {
                                                    # code...
